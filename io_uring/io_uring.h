...
/*
 * A handed off issue continues with the issue_flags it started with but
 * no longer holds the uring_lock: an io-wq worker that still has
 * PF_IO_HANDOFF set, cleared once the issue returns.
 */
