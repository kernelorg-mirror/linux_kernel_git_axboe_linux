...
/*
 * Take the accumulated exec runtime of @p, for handing it to another task.
 * The slice accounting only ever looks at the difference to
 * prev_sum_exec_runtime, keep that intact.
 */
